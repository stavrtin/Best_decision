...
a1 = input('Введите 1-е шестнадцатиричное число: ')
b1 = input('Введите 2-е шестнадцатиричное число: ')
...
print('Выполним проверку с помощью встроенного метода: ')
# a = 'a2'
# b= 'c4f'
print(f'Проверка сложения: {a1} + {b1} равно {hex(int(a1, 16) + int(b1, 16))}')
print(f'Проверка умножения: {a1} и {b1} равно {hex(int(a1, 16) * int(b1, 16))}')
