'''emias_ready.py от  28.10.2024
Исправлено: - убраны повторы визитов к id в одну и ту же дату!!!
'''
...
data_check = input('Версия 3. Убраны повторные визиты у одному и тому же пациенту в течении суток.')
data_check = input('Сначала необходимо сохранить свежие файлы ЕМИАС в папку z:/Проектный офис/Протоколы/.... Для продолжения - нажми "Enter"')
...
#  --------- Повторно избавляемся от ДУБЛЕЙ для одного и того же id в один и тот же день!!!
df_emias = df_emias.drop_duplicates(['ID пациента', 'Дата протокола'])
...
data_check = input('Сохранил в .... z:/Проектный офис/Протоколы/Все/Протокол_ЕМИАС_только_уник_визиты_ \n '
